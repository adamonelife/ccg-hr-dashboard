...
const TRANSLATIONS = {
  en: {
    ...
    'employeeForm.field.gender': 'Gender',
    'employeeForm.field.address': 'Address in Bali',
    'employeeForm.field.nationality': 'Nationality',
    'employeeForm.field.religion': 'Religion (for THR timing)',
    'employeeForm.field.marital_status': 'Marital status',
    'employeeForm.field.number_of_children': 'Number of children',
    ...
    'employeeForm.field.ktp_number': 'KTP / ID card number',
    'employeeForm.field.bni_account_number': 'BNI bank account number',
  ...
  id: {
    ...
    'employeeForm.field.gender': 'Jenis kelamin',
    'employeeForm.field.address': 'Alamat di Bali',
    'employeeForm.field.nationality': 'Kewarganegaraan',
    'employeeForm.field.religion': 'Agama (untuk waktu THR)',
    'employeeForm.field.marital_status': 'Status perkawinan',
    'employeeForm.field.number_of_children': 'Jumlah anak',
    ...
    'employeeForm.field.ktp_number': 'Nomor KTP',
    'employeeForm.field.bni_account_number': 'Nomor rekening BNI',
