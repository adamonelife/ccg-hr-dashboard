...
//
// TEMPLATE — not wired into any route. Copy this file when you build the
// first real HR feature that reads/writes a Google Sheet (leave balances,
// contract dates, wages, whatever). This is the CLIENT_EMAIL + PRIVATE_KEY
// JWT pattern used throughout the Ops Dashboard (Status Log, Xero Backfill,
// wages sheet) — by convention it's duplicated per-file rather than shared,
// so this file is meant to be copy-pasted, not imported.
//
